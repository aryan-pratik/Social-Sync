            ...
            <div className="max-w-6xl mx-auto px-5 sm:px-8">
                ...
                >
                    ...
                    <div className="relative">
                        ...
                        <p className="mt-6 text-gray-400 max-w-lg mx-auto  text-lg">Join thousands of creators and marketers who trust Social Sync to grow their audience on autopilot.</p>
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
                            ...
                            <a href="#pricing" className="bg-transparent text-white border-[1.5px] border-white/10 rounded-full font-medium hover:bg-white/5 hover:border-white/20 inline-flex items-center gap-2 text-[15px] px-10 py-4 w-full sm:w-auto justify-center">
                                View Pricing
                            </a>
                        </div>
