...
export default function Hero() {
    return (
        <section className="relative overflow-hidden">
            ...
            {/* Red soft glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[560px] bg-[radial-gradient(ellipse_at_center,rgba(139,92,246,0.15)_0%,transparent_70%)] pointer-events-none" />
            ...
            <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-20 pb-12 text-center">
                ...
                <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl xl:text-8xl text-white">
                    Schedule smarter.
                    <br />
                    <span className="text-violet-400 italic">Grow faster.</span>
                </h1>

                {/* Subheadline */}
                <p className="mt-7 text-gray-400 max-w-2xl mx-auto">Social Sync lets you create, schedule, and auto-engage across all your social platforms — powered by AI that writes your captions and replies for you.</p>
                ...
                <div className="mt-7 flex flex-col sm:flex-row items-center justify-center gap-3">
                    ...
                    <a href="#how-it-works" className="bg-transparent text-white border-[1.5px] border-white/10 rounded-full font-medium hover:bg-white/5 hover:border-white/20 inline-flex items-center gap-2 text-[15px] px-8 py-3.5 w-full sm:w-auto backdrop-blur justify-center transition-all">
                        See how it works
                    </a>
                </div>
            ...
            <div className="relative max-w-5xl mx-auto px-5 sm:px-8 pb-0">
                <div className="rounded-t-2xl overflow-hidden border border-white/10 border-b-0">
                    {/* Browser chrome */}
                    <div className="flex items-center gap-2 px-4 py-3" style={{ background: "#1e293b", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                        <div className="w-3 h-3 rounded-full bg-violet-400" />
                        <div className="w-3 h-3 rounded-full bg-amber-400" />
                        <div className="w-3 h-3 rounded-full bg-emerald-400" />
                        <div className="flex-1 mx-4 rounded-md h-5 max-w-xs bg-slate-900/80" />
                    </div>
                    ...
                    <div className="p-6" style={{ background: "#0f172a" }}>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
                            {[
                                ...
                                <div key={s.label} className="rounded-xl p-4 bg-slate-900" style={{ border: "1px solid rgba(255,255,255,0.06)" }}>
                        ...
                        {/* Activity list */}
                        <div className="rounded-xl p-4 space-y-3 bg-slate-900" style={{ border: "1px solid rgba(255,255,255,0.06)" }}>
