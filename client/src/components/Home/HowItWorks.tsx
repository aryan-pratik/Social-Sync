        ...
        <section id="how-it-works" className="py-24 bg-slate-900">
            <div className="max-w-4xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="mt-5 text-gray-400 max-w-lg mx-auto leading-relaxed">No complicated onboarding, no steep learning curve. Just connect, create, and grow.</p>
                </div>
                ...
                <div className="space-y-6">
                    {steps.map((s, i) => (
                        <div key={s.step} className="flex gap-6 items-start">
                            ...
                            <div className="pt-1">
                                <h3 className=" text-white mb-1">{s.title}</h3>
