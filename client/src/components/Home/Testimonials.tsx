...
const testimonials = [
    {
        ...
        text: "Social Sync has saved our team 10+ hours a week. The AI composer is genuinely impressive — it writes content that sounds like us.",
    },
    {
        name: "Marcus L.",
        role: "Indie Creator",
        ...
        <section className="py-24 bg-slate-800/50">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-14">
                    ...
                    <p className="mt-5 text-gray-400 max-w-md mx-auto">Join thousands of people who automate their social media with Social Sync.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    {testimonials.map((t, i) => (
                        <div key={i} className="bg-slate-900 rounded-2xl border border-slate-100 hover:border-white/10 hover:shadow-lg hover:shadow-slate-100 p-6 transition-all flex flex-col gap-4">
