...
const Account = () => {
  ...
  const fetchAccounts = async (isSync = false, platfroms: string | null, successMsg?: string) => {
    setAccounts(dummyAccountsData);
    console.log(isSync, platfroms, successMsg)
  }
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-sm">
      ...
      }} className="flex items-center gap-2 px-5 py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-full font-medium w-full sm:w-auto justify-center">
